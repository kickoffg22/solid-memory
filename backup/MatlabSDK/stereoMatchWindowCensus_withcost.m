function [D1,D2,C1min,C2min] = stereoMatchWindowCensus_withcost(I1, I2, window_radius, max_d,lambda_C,lambda_AD)
%Image allignment
[~,cols,~] = size(I1);
[rows,cols2,~] = size(I2);
if cols > cols2
...
C1min = C1min/(window_radius*2+1)^2;
C2min = C2min/(window_radius*2+1)^2;
end
