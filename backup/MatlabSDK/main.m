...
%   path = 'C:\Challenge\motorcycle';
    ...
    %---------------------------------------------------------------------%
    time_taken = toc;
    imshow([DisparityMap{1}/DisparityRange,DisparityMap_sparse{1}/DisparityRange;DisparityMap_sparse_fill/DisparityRange,D_full/DisparityRange;DisparityMap_sparse_full/DisparityRange,GT/DisparityRange]);
    colormap(gca,jet)
    drawnow;
