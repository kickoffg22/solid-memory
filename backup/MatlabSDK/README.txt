...
inside the MatlabSDK folder. 
A sample stereo method is included,
which uses 9x7 census cost, uniform window aggregation, winner take
all, and consistency checking.
It also calculates the error rates
using the ground truth images. 
